				...
				<div class="row">
					<div class="col-12">
							...
							<select name="p_language" id="p_language" class="form-control select2" required>
								<?php foreach($this->asset['SD_Language'] as $key => $val): ?>
									<?php if($val == $entry['p_language']): ?>
										<option value="<?=$val?>" selected="selected"><?=$this->asset['SD_LanguageFlag'][$val]?>&nbsp;&nbsp;<?=$key?></option>
									<?php else: ?>
						...
						<div class="form-group row">
							...
							<div class="col-md-4">
								<label class="form-label">P.IVA o Codice Fiscale ContraenteP.IVA o Codice Fiscale Contraente</label>
								<div class="col-sm-12 col-md-12">
				                    <div class="form-group">
				                      <label class="form-label">Font Size:</label>
						...
						<div class="form-group row">
							<div class="col-md-12">
								...
								<textarea name="p_surety_object" id="p_surety_object" class="form-control" required><?=(isset($entry['p_surety_object'])?$entry['p_surety_object']:'') ?></textarea>
							</div>
						</div>
						<div class="form-group">
