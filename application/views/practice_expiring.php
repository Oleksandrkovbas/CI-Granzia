<div class="page-header">
  <div class="page-leftheader"><h4 class="page-title">Pratiche in Scadenza</h4></div>
</div>
<div class="row">
            ...
            <table class="table card-table table-vcenter border" width="100%" id="example1">
              <thead>
                <tr>
                  ...
                  <th>Contraente</th>
                  <th>Beneficiario</th>
                  <th style="width:12%;">IMPORTO GARANTITO</th>
                  <th>Emissione</th>
                  <th>Durata</th>
                  <th>Creato da</th>
              ...
              <tbody>
                ...
                <?php else: ?>
                  ...
                  <tr>
					...
					<td>
					<?php
						if(isset($row['p_rif_code']) && $row['p_rif_code']!=""){
							echo "<strong>".str_replace(","," - ",$row['p_rif_code'])."</strong>";
						}
						else{
						?>
                    ...
                    <td class="text-nowrap align-middle">
                      <?php $today = date('Y-m-d'); if($row['p_to_date'] > $today): ?>
                        <span class="badge badge-warning badge-pill mt-2 font-weight-semibold">In Scadenza</span>
                      <?php else: ?>
                        <span class="badge badge-danger-light badge-pill mt-2 font-weight-semibold">Scaduta</span>
                      <?php endif; ?>
                    </td>
                    <td>
                      <div class="btn-group">
