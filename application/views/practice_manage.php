  ...
  <div class="col-lg-12" width="800px;">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col mb-4">
            <a href="<?=base_url().$this->add_url?>" class="btn btn-primary"><i class="fe fe-plus"></i> Aggiungi Pratica</a>
          </div>
          <!-- <div class="col col-auto mb-4">
            <div class="form-group w-100">
              <div class="input-icon">
                <span class="input-icon-addon"> <i class="fe fe-search"></i> </span> <input type="text" class="form-control" placeholder="Cerca Pratica" />
              </div>
            </div>
          </div> -->
        </div>
