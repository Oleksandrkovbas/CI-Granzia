(function($) {
	...
	/*Header Style*/
	$(document).on("click", '#onoffswitch3', function () {    
		if (this.checked) {
	...
	$(document).on("click", '#onoffswitch5', function ()  {    
		if (this.checked) {
	...
	/*Horizonatl-menu Style*/
	$(document).on("click", '#onoffswitch6', function () {    
		if (this.checked) {
			$('body').addClass('light-hor-menu');
			$('body').removeClass('color-hor-menu');
			$('body').removeClass('dark-hor-menu');
			localStorage.setItem("default-hor-menu", "True");
		}
		else {
	...
	$(document).on("click", '#onoffswitch7', function ()  {    
		if (this.checked) {
	...
	$(document).on("click", '#onoffswitch8', function ()  {    
		if (this.checked) {
	...
	$(document).on("click", '#onoffswitch9', function () {    
		if (this.checked) {
	...
	$(document).on("click", '#onoffswitch10', function ()  {    
		if (this.checked) {
	...
	$(document).on("click", '#onoffswitch11', function ()  {    
		if (this.checked) {
	...
	$(document).on("click", '#onoffswitch12', function () {    
		if (this.checked) {
			$('body').addClass('menu-style1');
			$('body').removeClass('menu-style2');
			$('body').removeClass('menu-style3');
	...
	$(document).on("click", '#onoffswitch13', function ()  {    
		if (this.checked) {
	...
	$(document).on("click", '#onoffswitch14', function ()  {    
		if (this.checked) {
			$('body').addClass('menu-style3');
			$('body').removeClass('menu-style1');
			$('body').removeClass('menu-style2');
			localStorage.setItem("menu-style3", "True");
		}
		else {
			$('body').removeClass('menu-style3');
			localStorage.setItem("menu-style3", "false");
		}
	});
	$(document).on("click", '#onoffswitch15', function ()  {    
		if (this.checked) {
			$('body').addClass('menu-style4');
			$('body').removeClass('default-style');
			localStorage.setItem("menu-style4", "True");
		}
		else {
			$('body').removeClass('menu-style4');
			localStorage.setItem("menu-style4", "false");
		}
	});
	$(document).on("click", '#onoffswitch16', function ()  {    
		if (this.checked) {
	...
	$(document).on("click", '#onoffswitch17', function () {    
		if (this.checked) {
			$('body').addClass('menu-style1');
			$('body').removeClass('menu-style2');
			$('body').removeClass('menu-style3');
	...
	$(document).on("click", '#onoffswitch18', function ()  {    
		if (this.checked) {
			$('body').addClass('menu-style2');
			$('body').removeClass('menu-style1');
			$('body').removeClass('menu-style3');
	...
	$(document).on("click", '#onoffswitch19', function ()  {    
		if (this.checked) {
			$('body').addClass('menu-style3');
			$('body').removeClass('menu-style1');
			$('body').removeClass('menu-style2');
